                    ...
                    <div class="flex-fill">
                        ...
                        <div class="card-body px-1 py-3">
                            <div class="table-responsive">
                                <table class="table table-sm table-borderless table-calendar">
...
function renderCalendar(m, y) {
  ...
  s_m.innerHTML = months[m] + ' <span class="dote"></span> ' + y;
  let date = 1;
        ...
        eventsList.forEach((event) =>
          $(".events-today").html(
            (eventsLi += `<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    ${event.eventText}
                    <button type="button" class="close remove-event" data-event-id="${event}" data-dismiss="alert" aria-label="Close">
